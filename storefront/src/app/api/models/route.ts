...
export async function GET(request: NextRequest) {
  try {
    ...
    // Determine path to the models in public/ca/models
    const rootPath = process.cwd();
    console.log(`Current directory: ${rootPath}`);

    // Updated paths to look in public/ca/models
    const possiblePaths = [
      // Primary path: public/ca/models/[lod]/[modelId].glb
      path.join(rootPath, 'public/ca/models', lod as string, `${modelId}.glb`),
      // Fallback: public/ca/models/[modelId].glb (without LOD subdirectory)
      path.join(rootPath, 'public/ca/models', `${modelId}.glb`),
      // Additional fallback: public/ca/models/[modelId]/[lod].glb
      path.join(rootPath, 'public/ca/models', modelId, `${lod}.glb`),
    ];
