...
export const updateMachiningServicesStep = createStep(
  "create-machining-services",
  async (service:Machining, { container }) => {
    console.log("WORKFLOW >> CREATE_MACHINING_SERVICES STEP: data", { service });
    ...
    //   createdServices.push(service);
      console.log("WORKFLOW >> CREATE_MACHINING_SERVICES STEP: Created machining service", createdService);
    // }
